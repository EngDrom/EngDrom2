...
class SearchableContextMenu_ConfigViewer extends Component {
    ...
    _render_name (props, use_icon) {
        ...
        return [ createElement("div", props, `relative py-1 pl-${this.depth * 5 + 6} pr-4 text-base font-300 cursor-pointer duration-300 hover:bg-Vwebdrom-light-background`, [
            ...(use_icon ? [icon] : []),
            createElement("div", {}, "", [
                this.config.name
            ])
...
class SearchableContextMenu extends Component {
    ...
    _first_render () {
        ...
        this.title_element = createElement("div", {}, "z-1000 select-none absolute bg-Vwebdrom-background px-4 py-1 text-lg", [ this.title ]);
        ...
        this.element = createElement("div", {}, "z-1000 absolute bg-Vwebdrom-navbar-background overflow-scroll", [
            ...(this.config.map((x) => {
